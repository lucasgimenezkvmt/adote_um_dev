    ...
    >
        <div class="flex flex-1 flex-col items-center justify-end text-2xl px-10">
            ...
            <button wire:click="loginWithGithub"
                class="flex flex-row space-x-2 justify-center items-center border-white border-2 border-solid p-4 text-black mb-8 mt-4 w-full text-sm rounded-full font-bold transform duration-150 active:scale-95"
            >
