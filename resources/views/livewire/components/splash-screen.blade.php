...
>
    ...
    >
        <div class="flex flex-col items-center justify-center space-y-2">
            <img class="w-14 h-14" src="{{ asset('assets/logo-adote-um-dev_h-doc.svg') }}" />
            <span class="text-white font-bold">AdoteUm.Dev</span>
        </div>
    </div>

    <div class="flex flex-col items-center justify-center min-h-screen w-full">
        <img x-ref="logo" class="w-14 h-14 transform scale-0 duration-1000" src="{{ asset('assets/logo-adote-um-dev_v-doc.svg') }}" />
